...
internal sealed class RegisterUseCase(IValidator<RegisterRequest> validator, UserDbContext context, IPasswordHasherProvider passwordHasher) : IRegisterUseCase
{
